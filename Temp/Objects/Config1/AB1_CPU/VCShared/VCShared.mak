...
VCUG_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Length.vcug \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Time_Sekunda.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Time_Minuta.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Time_Hodina.vcug 
...
$(AS_CPU_PATH)/VCShared/vcug.Time_Sekunda.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Time_Sekunda.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Time_Minuta.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Time_Minuta.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Time_Hodina.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Time_Hodina.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas
